...
from utils.new_buffers import RolloutBuffer
from utils.new_buffers import EntReplayBuffer
...
class DecoupledOnPolicyRewardAlgorithm(BaseAlgorithm):
    ...
    def learn_reward(self) -> None:
        ...
        self.reward_model._current_progress_remaining = self._current_progress_remaining
