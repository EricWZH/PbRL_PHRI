...
from train_schedule.decouple_task_and_preference_prefppo import DecoupledPrefPPO
from stable_baselines3.ppo import MlpPolicy
from utils.make_vec_separate_reward_env import make_vec_separate_reward_env
from utils.show_episode_reward_callbacks import ShowEpisodeRewardCallback
from typing import Any, Callable, Dict, List, Optional, Tuple, Union
from utils.separate_reward_vec_normalize import SeparateRewardVecNormalize
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", help="Random generator seed", type=int, default=2023)
    ...
    parser.add_argument("--reward-decay-rate", type=float, default=1.0)
